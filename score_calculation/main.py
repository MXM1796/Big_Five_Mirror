...
def youtube_api_connector(video_id):
    ...
    api_version = "v3"
    # old name backup: client_secret_2898000449-ra24ccl5cs05bln218sccqtasqtctrnp.apps.googleusercontent.com.json
...
df1.to_csv(f"transcripts/transcript_1.csv")
df2.to_csv("video_data/video_descr_1.csv")
