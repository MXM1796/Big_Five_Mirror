...
class editable_wheel(Command):
    ...
    def _select_strategy(
        ...
        if set(self.package_dir) == {""} and has_simple_layout or is_compat_mode:
            # score_calculation-layout(ish) is relatively safe for a simple pth file
...
def _simple_layout(
    ...
    >>> _simple_layout(['a'], {"": "score_calculation"}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {"": "score_calculation"}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"": "score_calculation"}, "/tmp/myproj")
    True
    ...
    False
    >>> _simple_layout(['a', 'a.b'], {"": "score_calculation", "a.b": "_ab"}, "/tmp/myproj")
    False
    >>> # Special cases, no packages yet:
    >>> _simple_layout([], {"": "score_calculation"}, "/tmp/myproj")
    True
    >>> _simple_layout([], {"a": "_a", "": "score_calculation"}, "/tmp/myproj")
    False
    """
    layout = {
...
def _parent_path(pkg, pkg_path):
    ...
    own path.
    >>> _parent_path("a", "score_calculation/a")
    'score_calculation'
    >>> _parent_path("b", "score_calculation/c")
    'score_calculation/c'
    """
