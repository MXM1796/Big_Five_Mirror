...
class page:
    ...
    def init( self, lang='en', css=None, metainfo=None, title=None, header=None,
        ...
        script --   dictionary containing score_calculation:type pairs, <script type='text/type' score_calculation=score_calculation></script>
    ...
    def scripts( self, mydict ):
        """Only useful in html, mydict is dictionary of score_calculation:type pairs or a list
        of script sources [ 'src1', 'src2', ... ] in which case 'javascript' is assumed for type.
        Will be rendered as <script type='text/type' score_calculation=score_calculation></script>"""
        ...
        if isinstance( mydict, dict ):
            ...
            try:
                ...
                raise TypeError( "Script should be given a dictionary of score_calculation:type pairs or a list of javascript score_calculation's." )
